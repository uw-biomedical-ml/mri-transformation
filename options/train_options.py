...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--with_logit_loss', action='store_true', help='For GAN only, specify if using BSEWtihLogitsLoss for GANLoss')
        self.parser.add_argument('--no_lsgan', action='store_true', help='For GAN only. do *not* use least square GAN, if false, use vanilla GAN')
